...
{
    public partial class ModelandProductColumnnewwhepsiniSildimveyenidenyapdimcolumnsonn : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Models_ParentsCategories_ParentsCategoryId",
                        column: x => x.ParentsCategoryId,
                        principalTable: "ParentsCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductİmageColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentsCategoryId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Features", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Features_ParentsCategories_ParentsCategoryId",
                        column: x => x.ParentsCategoryId,
                        principalTable: "ParentsCategories",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Features_ParentsCategoryId",
                table: "Features",
                column: "ParentsCategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Models_ParentsCategoryId",
                table: "Models",
                column: "ParentsCategoryId");
